...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/uds-plus/StructureDefinition/uds-plus-age-extension']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/us/uds-plus/StructureDefinition/uds-plus-age-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/uds-plus/StructureDefinition/uds-plus-age-extension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/uds-plus/StructureDefinition/uds-plus-age-extension': maximum cardinality of 'extension' is 1</sch:assert>
